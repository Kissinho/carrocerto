                        ...
                        <div class="card" style="width: 28rem;">
                            ...
                            <div class="card-body">
                                ...
                                <form method="post" name="myform">
                                   ...
                                   <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Modelo" name="txt_modelo" value="<%=modelo%>" required>

                     
                                    
                                   <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Versão" name="txt_versao" value="<%=versao%>" required>
